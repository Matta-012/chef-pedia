...
- Data de entrega para avaliação final do projeto: `19/10/2022 - 14:00h`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-015-b-project-recipes-app.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-015-b-project-recipes-app`
...
6. Crie um novo `Pull Request` _(PR)_
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-015-b-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
